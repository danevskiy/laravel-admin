                    ...
                    <div>
                        ...
                        <form action="{{ route('employee.update', ['id' => $id]) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{$data->first_name}}" name="first_name" class="form-control" id="first_name" aria-describedby="first_name">
                            </div>
                            <div class="mb-3">
                                <label for="last_name" class="form-label">Last name</label>
                                <input type="text" value="{{$data->last_name}}" name="last_name" class="form-control" id="last_name" aria-describedby="last_name">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{$data->phone}}" name="phone" class="form-control" id="phone" aria-describedby="phone">
                            </div>

                            <select class="mb-3 form-select form-select-lg" name="company_id" aria-label="companies">
                                <option @if($data->company_id == null) selected @endif value="">Select company</option>
